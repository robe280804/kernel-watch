...
ContainerSentry usa i **tracepoint** (punti di strumentazione stabili del kernel) su
...
- REST API / dashboard: una porta è configurata (`CS_API_PORT`) ma **non esistono
  handler HTTP**.
